...
rem Version 1.55(001) - Last Updated 26 May 2006.
...
@rem Skip wins urel on S80 SDK
if "%__OPXTARGET__%"=="thumb" goto skip_maybe2
goto do_it_now
...
:skip_maybe2
if "%__OPXVARIANT__%"=="urel" goto %__OPXRETURN__%

:do_it_now
echo !! DEBUG INFO: "%__OPXTARGET__% - %__OPXVARIANT__% - %__OPXCOMP__%OPX.pkg"
pause
