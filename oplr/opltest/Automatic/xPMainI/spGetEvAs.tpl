REM spGetEvAs.tpl
REM EPOC OPL script for interactive pGetEvAs.
...
PROC Standalone:
	...
	LOADM KhUtils$
	hLink:("spGetEvAs", hThreadIdFromOplDoc&:, KhUserFull%)
	REM After standalone completion, control returns here.
	dINIT "Tests complete" :DIALOG
ENDP

CONST kTarget$="\Opltest\Interactive\pMainI\pGetEvAs.opo"
...
PROC EventScript%:
	...
	REM Shift
	hSendKeyRich&:(KEvKeyDown&,0,KSyModifierShift&,0) 
	hSendKeyRich&:(KEvKeyup&,0,0,0) 
ENDP
