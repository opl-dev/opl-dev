REM tLong.tpl
REM EPOC OPL automatic test code for long integers.
...
PROC Standalone:
	...
	LOADM KhUtils$
	hLink:("tLong", hThreadIdFromOplDoc&:, KhUserFull%)
