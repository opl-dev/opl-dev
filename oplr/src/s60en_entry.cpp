...
#pragma message("s60en_entry.cpp: Disabling ExecuteCheck() __UHEAP_ checking.")
//	__UHEAP_MARK;
	ExecuteD();
//	__UHEAP_MARKEND;
...
// This whole file is only used for Series 60 code, but...
...
// have a go at mapping it to a command id...
	...
	__ASSERT_DEBUG(handledSelection,User::Invariant());

	CActiveScheduler::Stop();
	//consume the command here????
	}
