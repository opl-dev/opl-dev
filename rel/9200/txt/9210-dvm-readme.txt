OPL mini developer package v1.56 for Nokia 9200 Communicator Series.
...
Series Communicator to your PC and install \SisFiles\Other\OPL.sis in the normal way as described in 
the manual. If you wish to verify your installation you can optionally install 
\SisFiles\Other\DemoOPL.sis which will allow you to test OPL is properly installed.

To develop on the Nokia 9200 Series Communicator itself, additionally:

1) Install \SisFiles\Other\OPLDev.sis
