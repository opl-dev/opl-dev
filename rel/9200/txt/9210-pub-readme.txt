OPL runtime v1.56 for Nokia 9200 Communicator Series
...
the manual. If you wish to verify your installation you can optionally install DemoOPL.sis which will allow 
you to test OPL is properly installed.
